...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "finite-abelian-groups-20k10-torsion-canonical-lane",
  theoremObject := "Finite abelian groups are direct sums of primary cyclic groups (invariant factor decomposition).",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedTorsionClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_torsion_endgame A
